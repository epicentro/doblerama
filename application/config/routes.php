...
$route['categorias'] = "categoria/all";
$route['categoria-areas/(:any)'] = "categoria_areas/index/$1/";
$route['categoria/download/(:any)'] = "categoria/download/$1/";
$route['categoria/(:any)'] = "categoria/index/$1/";
$route['categoria/search'] = "categoria/search/";
$route['categoria-servicios/(:any)'] = "categoria_servicios/index/$1/";
$route['categoria-cursos/(:any)'] = "categoria_cursos/index/$1/";
