...
class be_categorias {
    ...
    public function html_mnto_hijo($tabla, $idtabla, $carpeta_imagen){
    ...
    public function recursivo_migajas_li_area($id){
        
                     $strsql="select idcategoria_areas, nombre, seo, padre_id from categoria_areas where idcategoria_areas='$id'";
                     $rn=$this->CI->modelo_base->c_una_fila($strsql);
                     
                     if($rn!="0"){
                       return " <li><a href='".base_url()."categoria-areas/".$rn->seo."'>".$rn->nombre."</a></li>".$this->recursivo_migajas_li_area($rn->padre_id);
                     }//endIf
    ...
    public function recursivo_migajas_li($id){
                     ...
                     if($rn!="0"){
                       //return " <li><a href='".base_url()."categoria/".$rn->seo."'>".$rn->nombre."</a></li>".$this->recursivo_migajas_li($rn->padre_id);
                       return " <li class='active'>".$rn->nombre."</li>".$this->recursivo_migajas_li($rn->padre_id);                       
                     }//endIf
