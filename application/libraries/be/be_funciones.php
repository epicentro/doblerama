...
class be_funciones {
  ...
  public function nombre_categoria($id){
   ...
   public function nombre_raya_abajo($nombre){
...
$nombre=str_replace("°", "", $nombre);         
   ...
   public function cantidad_word_cursos($id){

       $strsql="select count(*) as cantidad from cursos_word where idcursos='".$id."'";
       $fila=$this->CI->modelo_base->c_una_fila($strsql);
   ...
   public function cantidad_fotos_cursos($id){

       $strsql="select count(*) as cantidad from cursos_imagenes where idcursos='".$id."'";
       $fila=$this->CI->modelo_base->c_una_fila($strsql);
   ...
   public function cantidad_pdf_cursos($id){

       $strsql="select count(*) as cantidad from cursos_pdf where idcursos='".$id."'";
       $fila=$this->CI->modelo_base->c_una_fila($strsql);
   ...
   public function cantidad_fotos_areas($id){

       $strsql="select count(*) as cantidad from areas_imagenes where idareas='".$id."'";
       $fila=$this->CI->modelo_base->c_una_fila($strsql);
