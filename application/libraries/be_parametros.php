...
class be_parametros {
    ...
    public function sucursales_por_sede($id){
      
        $strsql="select * from mapas where idcategoria_mapas='$id'";
    ...
    public function lista_preguntas($id){
        ...
        $strsql="select * from preguntas where idcategoria_preguntas='$id'";
    ...
    public function archivos_atributo($id){
      
        $strsql="select b.nombre from productos_atributos a inner join atributos b on b.idatributos=a.idatributos where idproductos='$id'";
    ...
    public function primera_foto_areas($id){
      
        $strsql="select imagen from areas_imagenes where idareas='$id' and idprimera_foto=1 order by orden asc limit 1";
    ...
    public function primera_foto_cursos($id){
      
        $strsql="select imagen from cursos_imagenes where idcursos='$id' and idprimera_foto=1 order by orden asc limit 1";
    ...
    public function productos_categoria($id){
        ...
        $strsql="select * from productos where idcategoria_productos='$id' and  idprimera_hoja='1' and idsw='1'";
