 ...
 * @author Yasser
 */
class cursos_pdf extends CI_Controller {
    //put your code here
     
    public $tabla="cursos_pdf";
    public $idtabla="idcursos_pdf";
    public $carpeta_img="pdf_cursos";
   ...
   public function imagen_nombre(){
       ...
       rename ('./'.$this->carpeta_img.'/'.$imagen, './'.$this->carpeta_img.'/'.$renombrar.'.pdf');

       $newFile=$renombrar.".pdf";
      ...
      $this->validacion->validacion_login();
       ...
       $aleatorio=random_string('alnum', 5);   
        ...
        if ( ! $this->upload->do_upload("imagen")){//En esta linea es que subimos la imagen
            ...
            $idcursos_pdf=$this->uri->segment(5);
            if($idcursos_pdf=="0"){//si es igual a cero es nuevo registro
            ...
            }else{//si $idcursos_pdf no es cero entonces es una actualizacion
                
                
                    //ANTES DE GRABAR BORRAMOS EL LAS IMAGENES ANTERIORES
                    $strsql="select imagen from $this->tabla where id$this->tabla='$id' and idcursos_pdf='$idcursos_pdf'";
   ...
   public function imagen(){
      ...
      $this->validacion->validacion_login();
       ...
       $aleatorio=random_string('alnum', 5);   
        ...
        $config['upload_path'] = './'.$this->carpeta_img.'/';
        $config['allowed_types'] = 'doc|docx|xls|xlsx|pdf|txt|gif|jpg|png|jpeg';
        //$config['allowed_types'] = '*';
        $config['max_size'] = '20000';
                                ...
                                if ( ! $this->image_lib->resize()){//En esta linea redimensionamos la imagen a 170 x 220
                                    ...
                                    echo $this->image_lib->display_errors();
                                        ...
                                        if($idcursos_pdf=="0"){//si es igual a cero es nuevo registro
                                                ...
                                                //ANTES DE GRABAR BORRAMOS EL LAS IMAGENES ANTERIORES
                                                $strsql="select imagen from $this->tabla where id$this->tabla='$idcursos_pdf' and idcursos='$id'";
