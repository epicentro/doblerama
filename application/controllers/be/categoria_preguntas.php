 ...
 * @author Yasser
 */
class categoria_preguntas extends CI_Controller {
    //put your code here
     
    public $tabla="categoria_preguntas";
    ...
    public $estructura=array( 
        ...
        array('nombre_campo'=>'idcategoria_preguntas', 'tipo'=>'varchar', 'show'=>'no' ,'clave'=>'primaria', 'rotulo'=>'', 'valor'=>''),
    ...
    public function listar(){
             ...
             $data['filas']=$this->be_categorias->html_mnto_hijo("$this->tabla", "id$this->tabla", "$this->carpeta_img");
...
public function editar(){
   ...
   function elimina_categoria(){
       ...
       $this->validacion->validacion_login();
          ...
          $strsql="select count(*) as cantidad from preguntas where id$this->tabla='$id'";
