...
class preguntas extends CI_Controller {
    ...
    public $idtabla="idpreguntas";
    public $carpeta_img="img_preguntas";
    
    public $tabla_padre="categoria_preguntas";
    public $idtabla_padre="idcategoria_preguntas";
    ...
    public $estructura=array( 
        ...
        //idpreguntas, idcategoria_preguntas, title, keyword, description, nombre, seo, codigo, sumilla, descripcion, ficha_tecnica, idsw
        array('nombre_campo'=>'idpreguntas', 'tipo'=>'varchar', 'show'=>'no' ,'clave'=>'primaria', 'rotulo'=>'', 'multinivel'=>'no', 'valor'=>''),
        array('nombre_campo'=>'idcategoria_preguntas', 'tipo'=>'varchar', 'show'=>'si' ,'clave'=>'foranea', 'rotulo'=>'Categoria', 'multinivel'=>'si', 'valor'=>''),
        ...
        array('nombre_campo'=>'pregunta', 'tipo'=>'varchar', 'show'=>'si', 'clave'=>'no', 'rotulo'=>'Pregunta', 'multinivel'=>'no', 'valor'=>''),
        ...
        array('nombre_campo'=>'respuesta', 'tipo'=>'text', 'show'=>'si', 'clave'=>'no', 'rotulo'=>'Respuesta', 'multinivel'=>'no', 'valor'=>''),
        ...
        $this->validacion->validacion_login();
         ...
         $valor=$this->modelo_base->ejecuta($strsql);
             ...
             if($valor==1){
                 ...
                 $idpreguntas=$this->db->insert_id();
                 $idusuario=$this->session->userdata("idusuarios");
                 //Actualizamos el Kardex
                 //$this->be_funciones->kardex('1',$stock, $idpreguntas, $idusuario , '' , '' );
...
public function editar(){
   ...
   public function stock(){
       ...
       $strsql="update preguntas set stock='$stock' where idpreguntas='$id'";
       $valor=$this->modelo_base->ejecuta($strsql);
       if($valor==1){
   ...
   public function atributos(){
       ...
       if($verificar=="0"){
           $strsql="INSERT into preguntas_atributos (idpreguntas, idatributos) values ('$id', '$cbo_atributos')";
           $valor=$this->modelo_base->ejecuta($strsql);
   ...
   function elimina_categoria(){
       ...
       $this->validacion->validacion_login();
          ...
          /*
           //Averiguamos si la categoria tiene preguntas dependiente
 ...
 function elimina_preguntas(){
       ...
       $this->validacion->validacion_login();
          ...
          /*
          $strsql="select count(*) as cantidad from detalle where idpreguntas='$id'";
          $row=$this->modelo_base->c_una_fila($strsql);
          if($row->cantidad > 0 ){
          ...
          */
           ...
           //eliminamos  de preguntas atributos
            //$strsql="delete from preguntas_atributos where id$this->tabla='$id'";
            //$this->modelo_base->ejecuta($strsql);
            
            //eliminamos  de preguntas_comentarios
            //$strsql="delete from preguntas_comentarios where id$this->tabla='$id'";
            //$this->modelo_base->ejecuta($strsql);
