 ...
 * @author Yasser
 */
class categoria_cursos extends CI_Controller {
    //put your code here
     
    public $tabla="categoria_cursos";
    ...
    public $estructura=array( 
        ...
        array('nombre_campo'=>'idcategoria_cursos', 'tipo'=>'varchar', 'show'=>'no' ,'clave'=>'primaria', 'rotulo'=>'', 'valor'=>''),
...
public function editar(){
   ...
   function elimina_categoria(){
       ...
       $this->validacion->validacion_login();
          ...
          $strsql="select count(*) as cantidad from cursos where id$this->tabla='$id'";
