 ...
 * @author Yasser
 */
class cursos_imagenes extends CI_Controller {
    //put your code here
     
    public $tabla="cursos_imagenes";
    public $idtabla="idcursos_imagenes";
    public $carpeta_img="img_cursos";
    
    public $tabla_padre="cursos";
    public $idtabla_padre="idcursos";
    
    public $imagen_ancho=364;
    public $imagen_alto=254;
      ...
      $this->validacion->validacion_login();
       ...
       $aleatorio=random_string('alnum', 5);   
        ...
        if ( ! $this->upload->do_upload("imagen")){//En esta linea es que subimos la imagen
            ...
            $idcursos_imagenes=$this->uri->segment(5);
            if($idcursos_imagenes=="0"){//si es igual a cero es nuevo registro
            ...
            }else{//si $idcursos_imagenes no es cero entonces es una actualizacion
                
                
                    //ANTES DE GRABAR BORRAMOS EL LAS IMAGENES ANTERIORES
                    $strsql="select imagen from $this->tabla where id$this->tabla='$id' and idcursos_imagenes='$idcursos_imagenes'";
                    ...
                    $strsql="update $this->tabla set imagen='$file', idcursos='$id' where 
                            idcursos_imagenes='$idcursos_imagenes'";
 ...
 public function imagen(){
   ...
   function elimina_cursos_imagenes(){
