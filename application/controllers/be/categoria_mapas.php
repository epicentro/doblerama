 ...
 * @author Yasser
 */
class categoria_mapas extends CI_Controller {
    //put your code here
     
    public $tabla="categoria_mapas";
    ...
    public $estructura=array( 
        ...
        array('nombre_campo'=>'idcategoria_mapas', 'tipo'=>'varchar', 'show'=>'no' ,'clave'=>'primaria', 'rotulo'=>'', 'valor'=>''),
...
public function editar(){
  ...
  function elimina_categoria(){
       ...
       $this->validacion->validacion_login();
          ...
          $strsql="select count(*) as cantidad from mapas where id$this->tabla='$id'";
