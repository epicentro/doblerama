...
class mapas extends CI_Controller {
    ...
    public $tabla="mapas";
    public $idtabla="idmapas";
    public $carpeta_img="img_mapas";
    
    public $tabla_padre="categoria_mapas";
    public $idtabla_padre="idcategoria_mapas";
    ...
    public $estructura=array( 
        ...
        //idmapas, idcategoria_mapas, title, keyword, description, nombre, seo, codigo, sumilla, descripcion, ficha_tecnica, idsw
        array('nombre_campo'=>'idmapas', 'tipo'=>'varchar', 'show'=>'no' ,'clave'=>'primaria', 'rotulo'=>'', 'multinivel'=>'no', 'valor'=>''),
        array('nombre_campo'=>'idcategoria_mapas', 'tipo'=>'varchar', 'show'=>'si' ,'clave'=>'foranea', 'rotulo'=>'Categoria', 'multinivel'=>'si', 'valor'=>''),
        ...
        array('nombre_campo'=>'direccion', 'tipo'=>'varchar', 'show'=>'si', 'clave'=>'no', 'rotulo'=>'Dirección', 'multinivel'=>'no', 'valor'=>''),                
        array('nombre_campo'=>'telefono', 'tipo'=>'varchar', 'show'=>'si', 'clave'=>'no', 'rotulo'=>'Teléfonos', 'multinivel'=>'no', 'valor'=>''),                
        array('nombre_campo'=>'celular', 'tipo'=>'varchar', 'show'=>'si', 'clave'=>'no', 'rotulo'=>'Celular', 'multinivel'=>'no', 'valor'=>''),                                
        ...
        array('nombre_campo'=>'zoom', 'tipo'=>'varchar', 'show'=>'no', 'clave'=>'no', 'rotulo'=>'Zoom', 'multinivel'=>'no', 'valor'=>''),
        array('nombre_campo'=>'tipomapa', 'tipo'=>'varchar', 'show'=>'no', 'clave'=>'no', 'rotulo'=>'Tipo de mapa', 'multinivel'=>'no', 'valor'=>''),                
        ...
        $this->validacion->validacion_login();
         ...
         $valor=$this->modelo_base->ejecuta($strsql);
             ...
             if($valor==1){
                 ...
                 $idmapas=$this->db->insert_id();
                 $idusuario=$this->session->userdata("idusuarios");
                 //Actualizamos el Kardex
                 //$this->be_funciones->kardex('1',$stock, $idmapas, $idusuario , '' , '' );
...
public function editar(){
   ...
   public function stock(){
       ...
       $strsql="update mapas set stock='$stock' where idmapas='$id'";
       $valor=$this->modelo_base->ejecuta($strsql);
       if($valor==1){
   ...
   public function atributos(){
       ...
       if($verificar=="0"){
           $strsql="INSERT into mapas_atributos (idmapas, idatributos) values ('$id', '$cbo_atributos')";
           $valor=$this->modelo_base->ejecuta($strsql);
   ...
   function elimina_categoria(){
       ...
       $this->validacion->validacion_login();
          ...
          /*
           //Averiguamos si la categoria tiene mapas dependiente
 ...
 function elimina_mapas(){
       ...
       $this->validacion->validacion_login();
          ...
          /*
          $strsql="select count(*) as cantidad from detalle where idmapas='$id'";
          $row=$this->modelo_base->c_una_fila($strsql);
          if($row->cantidad > 0 ){
          ...
          */
           ...
           //eliminamos  de mapas atributos
            //$strsql="delete from mapas_atributos where id$this->tabla='$id'";
            //$this->modelo_base->ejecuta($strsql);
            
            //eliminamos  de mapas_comentarios
            //$strsql="delete from mapas_comentarios where id$this->tabla='$id'";
            //$this->modelo_base->ejecuta($strsql);
            ...
            // $strsql="select imagen from mapas_imagenes where id$this->tabla='$id'";
            // $fila=$this->modelo_base->c_una_fila($strsql);
            // //echo $strsql;
            // //echo $fila;
