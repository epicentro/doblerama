...
class areas extends CI_Controller {
    ...
    public $tabla="areas";
    public $idtabla="idareas";
    public $carpeta_img="img_areas";
    
    public $tabla_padre="categoria_areas";
    public $idtabla_padre="idcategoria_areas";
    ...
    public $estructura=array( 
        ...
        //idareas, idcategoria_areas, title, keyword, description, nombre, seo, codigo, sumilla, descripcion, ficha_tecnica, idsw
        array('nombre_campo'=>'idareas', 'tipo'=>'varchar', 'show'=>'no' ,'clave'=>'primaria', 'rotulo'=>'', 'multinivel'=>'no', 'valor'=>''),
        array('nombre_campo'=>'idcategoria_areas', 'tipo'=>'varchar', 'show'=>'si' ,'clave'=>'foranea', 'rotulo'=>'Categoria', 'multinivel'=>'si', 'valor'=>''),
        ...
        $this->validacion->validacion_login();
         ...
         $valor=$this->modelo_base->ejecuta($strsql);
             ...
             if($valor==1){
                 ...
                 $idareas=$this->db->insert_id();
                 $idusuario=$this->session->userdata("idusuarios");
                 //Actualizamos el Kardex
                 //$this->be_funciones->kardex('1',$stock, $idareas, $idusuario , '' , '' );
...
public function editar(){
   ...
   public function stock(){
       ...
       $strsql="update areas set stock='$stock' where idareas='$id'";
       $valor=$this->modelo_base->ejecuta($strsql);
       if($valor==1){
   ...
   public function atributos(){
       ...
       if($verificar=="0"){
           $strsql="INSERT into areas_atributos (idareas, idatributos) values ('$id', '$cbo_atributos')";
           $valor=$this->modelo_base->ejecuta($strsql);
   ...
   function elimina_categoria(){
       ...
       $this->validacion->validacion_login();
          ...
          /*
           //Averiguamos si la categoria tiene areas dependiente
 ...
 function elimina_areas(){
       ...
       $this->validacion->validacion_login();
          ...
          /*
          $strsql="select count(*) as cantidad from detalle where idareas='$id'";
          $row=$this->modelo_base->c_una_fila($strsql);
          if($row->cantidad > 0 ){
          ...
          */
           ...
           //eliminamos  de areas atributos
            //$strsql="delete from areas_atributos where id$this->tabla='$id'";
            //$this->modelo_base->ejecuta($strsql);
            
            //eliminamos  de areas_comentarios
            //$strsql="delete from areas_comentarios where id$this->tabla='$id'";
            //$this->modelo_base->ejecuta($strsql);
            ...
            $strsql="select imagen from areas_imagenes where id$this->tabla='$id'";
            $fila=$this->modelo_base->c_una_fila($strsql);
            //echo $strsql;
            //echo $fila;
