...
class cursos extends CI_Controller {
    ...
    public $carpeta_img="img_cursos";
    
    public $tabla_padre="categoria_cursos";
    public $idtabla_padre="idcategoria_cursos";
    ...
    public $estructura=array( 
        ...
        // SI EL TIPO DE CAMPO ES VARCHAR, INTEGER, DECIMAL LO PONEMOS COMO VARCHAR PARA CREA832RLE UN TEXTBOX
        // SI EL TIPO DE CAMPO ES TEXT  LE CREAMOS UN TEXTAREA CON FCKEDITOR
        
        //idcursos, idcategoria_cursos, title, keyword, description, nombre, seo, codigo, sumilla, descripcion, ficha_tecnica, idsw
        array('nombre_campo'=>'idcursos', 'tipo'=>'varchar', 'show'=>'no' ,'clave'=>'primaria', 'rotulo'=>'', 'multinivel'=>'no', 'valor'=>''),
        //array('nombre_campo'=>'idcategoria_cursos', 'tipo'=>'varchar', 'show'=>'si' ,'clave'=>'foranea', 'rotulo'=>'Categoria', 'multinivel'=>'si', 'valor'=>''),
        ...
        //array('nombre_campo'=>'tags', 'tipo'=>'varchar', 'show'=>'si', 'clave'=>'no', 'rotulo'=>'Tags', 'multinivel'=>'no', 'valor'=>''),        
        ...
        array('nombre_campo'=>'idsw', 'tipo'=>'varchar', 'show'=>'si', 'clave'=>'foranea', 'rotulo'=>'Programado', 'multinivel'=>'no', 'valor'=>''),
        ...
        array('nombre_campo'=>'duracion', 'tipo'=>'text', 'show'=>'si', 'clave'=>'no', 'rotulo'=>'Duracion', 'multinivel'=>'no', 'valor'=>''),        
        array('nombre_campo'=>'modalidad', 'tipo'=>'text', 'show'=>'si', 'clave'=>'no', 'rotulo'=>'Modalidad', 'multinivel'=>'no', 'valor'=>'')
        ...
        $this->validacion->validacion_login();
         ...
         $valor=$this->modelo_base->ejecuta($strsql);
             ...
             if($valor==1){
                 ...
                 $idcursos=$this->db->insert_id();
                 $idusuario=$this->session->userdata("idusuarios");
                 //Actualizamos el Kardex
                 //$this->be_funciones->kardex('1',$stock, $idcursos, $idusuario , '' , '' );
...
public function editar(){
   ...
   public function stock(){
       ...
       $strsql="update cursos set stock='$stock' where idcursos='$id'";
       $valor=$this->modelo_base->ejecuta($strsql);
       if($valor==1){
   ...
   public function atributos(){
       ...
       if($verificar=="0"){
           $strsql="INSERT into cursos_atributos (idcursos, idatributos) values ('$id', '$cbo_atributos')";
           $valor=$this->modelo_base->ejecuta($strsql);
   ...
   function elimina_categoria(){
       ...
       $this->validacion->validacion_login();
          ...
          /*
           //Averiguamos si la categoria tiene cursos dependiente
 ...
 function elimina_cursos(){
       ...
       $this->validacion->validacion_login();
          ...
          /*
          $strsql="select count(*) as cantidad from detalle where idcursos='$id'";
          $row=$this->modelo_base->c_una_fila($strsql);
          if($row->cantidad > 0 ){
          ...
          */
           ...
           //eliminamos  de cursos atributos
            //$strsql="delete from cursos_atributos where id$this->tabla='$id'";
            //$this->modelo_base->ejecuta($strsql);
            
            //eliminamos  de cursos_comentarios
            //$strsql="delete from cursos_comentarios where id$this->tabla='$id'";
            //$this->modelo_base->ejecuta($strsql);
            ...
            $strsql="select imagen from cursos_imagenes where id$this->tabla='$id'";
            $fila=$this->modelo_base->c_una_fila($strsql);
            if($fila<>"0"){
