 ...
 * @author Yasser
 */
class categoria_areas extends CI_Controller {
    //put your code here
     
    public $tabla="categoria_areas";
    ...
    public $estructura=array( 
        ...
        array('nombre_campo'=>'idcategoria_areas', 'tipo'=>'varchar', 'show'=>'no' ,'clave'=>'primaria', 'rotulo'=>'', 'valor'=>''),
