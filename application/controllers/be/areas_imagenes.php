 ...
 * @author Yasser
 */
class areas_imagenes extends CI_Controller {
    //put your code here
     
    public $tabla="areas_imagenes";
    public $idtabla="idareas_imagenes";
    public $carpeta_img="img_areas";
    
    public $tabla_padre="areas";
    public $idtabla_padre="idareas";
 ...
 public function imagen(){
                                        ...
                                        $this->equi_foto($file, $ruta, $ancho_deseado, $alto_deseado);
                                           ...
                                           if ( ! $this->image_lib->resize()){//En esta linea redimensionamos la imagen a 170 x 220
                                               ...
                                               echo $this->image_lib->display_errors();
                                                        ...
                                                        $idareas_imagenes=$this->uri->segment(5);
                                                        if($idareas_imagenes=="0"){//si es igual a cero es nuevo registro

                                                                //Ya tenemos creado la imagen y el Thumbnails, ahora grabamos

                                                                $strsql="insert into $this->tabla ( imagen, idareas )values ('$file','$id')";
                                                                $valor=$this->modelo_base->ejecuta($strsql);

                                                        }else{//si $idareas_imagenes no es cero entonces es una actualizacion


                                                                //ANTES DE GRABAR BORRAMOS EL LAS IMAGENES ANTERIORES
                                                                $strsql="select imagen from $this->tabla where id$this->tabla='$id' and idareas_imagenes='$idareas_imagenes'";
                                                                ...
                                                                //ACTUALIZAMOS
                                                                $strsql="update $this->tabla set imagen='$file', idareas='$id' where 
                                                                        idareas_imagenes='$idareas_imagenes'";
   ...
   function elimina_areas_imagenes(){
