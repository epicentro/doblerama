 ...
 * @author Yasser
 */
class cursos_programa extends CI_Controller {
    //put your code here
    ...
    public function listar(){
            ...
            $strsql="select  programacion from $this->tabla 
                    where $this->idtabla='$id' ";          
            
          
        $fila=$this->modelo_base->c_una_fila($strsql);

        $data['valor']=$fila->programacion;
   ...
   public function grabar(){
       ...
       $strsql="update cursos set programacion='$valor' where idcursos='$id'";
       
       
       $this->modelo_base->ejecuta($strsql);
       $url=base_url()."be/cursos_programa/listar/$id";
