...
class atributos extends CI_Controller {
    ...
    public $tabla="atributos";
    public $carpeta_img="img_atributos";
    ...
    public $estructura=array( 
        ...
        array('nombre_campo'=>'idatributos', 'tipo'=>'varchar', 'show'=>'no' ,'clave'=>'primaria', 'rotulo'=>'', 'valor'=>''),
