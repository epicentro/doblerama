...
class valores extends CI_Controller {
    ...
    public $tabla="valores";
    public $idtabla="idvalores";
    public $carpeta_img="img_valores";
    
    public $tabla_padre="categoria_valores";
    public $idtabla_padre="idcategoria_valores";
    ...
    public $estructura=array( 
        ...
        //idvalores, idcategoria_valores, title, keyword, description, nombre, seo, codigo, sumilla, descripcion, ficha_tecnica, idsw
        array('nombre_campo'=>'idvalores', 'tipo'=>'varchar', 'show'=>'no' ,'clave'=>'primaria', 'rotulo'=>'', 'multinivel'=>'no', 'valor'=>''),
        ...
        array('nombre_campo'=>'icon', 'tipo'=>'varchar', 'show'=>'si', 'clave'=>'no', 'rotulo'=>'Icono', 'multinivel'=>'no', 'valor'=>''),        
        ...
        $this->validacion->validacion_login();
         ...
         $valor=$this->modelo_base->ejecuta($strsql);
             ...
             if($valor==1){
                 ...
                 //$this->be_funciones->kardex('1',$stock, $idvalores, $idusuario , '' , '' );
...
public function editar(){
   ...
   public function stock(){
       ...
       $strsql="update valores set stock='$stock' where idvalores='$id'";
       $valor=$this->modelo_base->ejecuta($strsql);
       if($valor==1){
   ...
   public function atributos(){
       ...
       if($verificar=="0"){
           $strsql="INSERT into valores_atributos (idvalores, idatributos) values ('$id', '$cbo_atributos')";
           $valor=$this->modelo_base->ejecuta($strsql);
   ...
   function elimina_categoria(){
       ...
       $this->validacion->validacion_login();
          ...
          /*
           //Averiguamos si la categoria tiene valores dependiente
 ...
 function elimina_valores(){
       ...
       $this->validacion->validacion_login();
          ...
          /*
          $strsql="select count(*) as cantidad from detalle where idvalores='$id'";
          $row=$this->modelo_base->c_una_fila($strsql);
          if($row->cantidad > 0 ){
          ...
          */
           ...
           //eliminamos  de valores atributos
            //$strsql="delete from valores_atributos where id$this->tabla='$id'";
            //$this->modelo_base->ejecuta($strsql);
            
            //eliminamos  de valores_comentarios
            //$strsql="delete from valores_comentarios where id$this->tabla='$id'";
            //$this->modelo_base->ejecuta($strsql);
