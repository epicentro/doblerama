   <div id="content_main" class="clearfix">
                ...
                <div id="dashboard_y">
				<h2 class="ico_mug"> Mnto. de los Valores</h2>
				<div class="clearfix">
...
<!--             <th>Presentacion</th>
	...
	<tr>
            <td style="width: 30px;"><?php echo $row->idvalores; ?></td>
            ...
            <td style="text-align: center;" >
                 <p>
                     <?php //echo $this->be_funciones->cantidad_fotos($row->idvalores); ?>
                 </p>
                <a href="<?php echo base_url(); ?>be/valores_programa/listar/<?php echo $row->$idtabla; ?>">
...
<!--             <td style="text-align: center;" >
                ...
                <a href="<?php echo base_url(); ?>be/valores_presentacion/listar/<?php echo $row->$idtabla; ?>">
                <img class="img_link"  src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
                </a>
            </td>
             ...
             <td style="text-align: center;" >
                 <p>
                     <?php echo $this->be_funciones->cantidad_fotos_servicio($row->idvalores); ?>
                 </p>
                <a href="<?php echo base_url(); ?>be/valores_imagenes/listar/<?php echo $row->$idtabla; ?>">
                <img class="img_link"  src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
                </a>
            </td>
             -->
            ...
            <td style="text-align: center;" >
                 <p>
                     <?php echo $this->be_funciones->cantidad_comentarios($row->idvalores); ?>
                 </p>
                <a href="<?php echo base_url(); ?>be/valores_comentarios/listar/<?php echo $row->$idtabla; ?>">
                <img class="img_link"  src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
                </a>
            </td>
            -->
           <td style="text-align: center;"><?php echo $row->orden; ?></td>
            ...
            <th style="text-align: center;" >
                        ...
                        <img class="img_link" onclick = "javascript:elimina_valores('<?php echo $row->$idtabla; ?>')" src="<?php echo base_url();?>img/cancel.png" width="16" height="16" title="Eliminar"/>
