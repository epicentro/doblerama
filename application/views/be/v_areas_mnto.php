   <div id="content_main" class="clearfix">
                ...
                <div id="dashboard_y">
				<h2 class="ico_mug"> Mnto. de areas</h2>
				<div class="clearfix">
...
<table  cellpadding="0" cellspacing="0" class="tb_mnto">
	...
	<tr>
            <td style="width: 30px;"><?php echo $row->idareas; ?></td>
            ...
            <td style="text-align: center;" >
                 <p>
                     <?php //echo $this->be_funciones->cantidad_fotos($row->idareas); ?>
                 </p>
                <a href="<?php echo base_url(); ?>be/areas_programa/listar/<?php echo $row->$idtabla; ?>">
            ...
            <td style="text-align: center;" >
                ...
                <a href="<?php echo base_url(); ?>be/areas_presentacion/listar/<?php echo $row->$idtabla; ?>">
                <img class="img_link"  src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
                </a>
            </td>
             ...
             <td style="text-align: center;" >
                 <p>
                     <?php echo $this->be_funciones->cantidad_fotos_areas($row->idareas); ?>
                 </p>
                <a href="<?php echo base_url(); ?>be/areas_imagenes/listar/<?php echo $row->$idtabla; ?>">
                <img class="img_link"  src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
                </a>
            </td>
            ...
            <td style="text-align: center;" >
                 <p>
                     <?php echo $this->be_funciones->cantidad_comentarios($row->idareas); ?>
                 </p>
                <a href="<?php echo base_url(); ?>be/areas_comentarios/listar/<?php echo $row->$idtabla; ?>">
                <img class="img_link"  src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
                </a>
            </td>
            -->
           <td style="text-align: center;"><?php echo $row->orden; ?></td>
            ...
            <th style="text-align: center;" >
                        ...
                        <img class="img_link" onclick = "javascript:elimina_areas('<?php echo $row->$idtabla; ?>')" src="<?php echo base_url();?>img/cancel.png" width="16" height="16" title="Eliminar"/>
