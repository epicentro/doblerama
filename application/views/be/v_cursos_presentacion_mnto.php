 ...
 <script type="text/javascript" src="<?php echo base_url();?>js/fckeditor/fckeditor.js"></script>
    ...
    <div id="content_main" class="clearfix">
                ...
                <div id="dashboard_y">
				<h2 class="ico_mug"> Inscripciones para : <?php echo $nombre; ?></h2>
				<div class="clearfix">
                         ...
                         <form id="form1" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>be/cursos_presentacion/grabar/<?php echo $id; ?>" onsubmit="return validar();" >
