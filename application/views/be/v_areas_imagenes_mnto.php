...
<table  cellpadding="0" cellspacing="0" class="tb_mnto">
	...
	<tr>
            ...
            <td>
                ...
                <img class="img_link" onclick="abrir_popup('<?php echo base_url()."be/areas_imagenes/v_imagen_orden/$id/".$row->idareas_imagenes;?>',1000,230);" src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
            </td>

          <td>
                <?php  if($row->idprimera_foto=="1"){echo "Si";}else{ echo "No"; } ?><br/>
                <img class="img_link" onclick="abrir_popup('<?php echo base_url()."be/areas_imagenes/v_imagen_pf/$id/".$row->idareas_imagenes;?>',1000,230);" src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
            </td>
            ...
            <td style="text-align: center;" >
                        ...
                        <img class="img_link" onclick="abrir_popup('<?php echo base_url()."be/areas_imagenes/v_imagen_editar/$id/".$row->$idtabla;?>',1000,530);" src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;

                        <img class="img_link" onclick = "javascript:elimina_areas_imagenes('<?php echo $row->$idtabla; ?>')" src="<?php echo base_url();?>img/cancel.png" width="16" height="16" title="Eliminar"/>
...
<?php 
    ...
    if(!$this->session->userdata('ruta_mnto_areas')){
           
           $ruta=$_SERVER['HTTP_REFERER'];
           $this->session->set_userdata('ruta_mnto_areas', $ruta);
       }
...
$("#save").click(function(){
    ...
    window.location.href="<?php echo $this->session->userdata('ruta_mnto_areas');?>";
