...
<table  cellpadding="0" cellspacing="0" class="tb_mnto">
  ...
  <tr>
            ...
            <td>
                ...
                <img class="img_link" onclick="abrir_popup('<?php echo base_url()."be/cursos_imagenes/v_imagen_orden/$id/".$row->idcursos_imagenes;?>',1000,230);" src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
            </td>

          <td>
                <?php  if($row->idprimera_foto=="1"){echo "Si";}else{ echo "No"; } ?><br/>
                <img class="img_link" onclick="abrir_popup('<?php echo base_url()."be/cursos_imagenes/v_imagen_pf/$id/".$row->idcursos_imagenes;?>',1000,230);" src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
            </td>
            ...
            <td style="text-align: center;" >
                        ...
                        <img class="img_link" onclick="abrir_popup('<?php echo base_url()."be/cursos_imagenes/v_imagen_editar/$id/".$row->$idtabla;?>',1000,530);" src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;

                        <img class="img_link" onclick = "javascript:elimina_cursos_imagenes('<?php echo $row->$idtabla; ?>')" src="<?php echo base_url();?>img/cancel.png" width="16" height="16" title="Eliminar"/>
