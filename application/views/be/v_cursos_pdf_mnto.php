   <div id="content_main" class="clearfix">
                ...
                <div id="dashboard_y">
        <h2 class="ico_mug"> PDF : <?php echo $nombre; ?></h2>
        <div class="clearfix">
...
<table  cellpadding="0" cellspacing="0" class="tb_mnto">
  ...
  <tr>
            ...
            <td><?php echo $row->nombre; ?><br/>
                <img class="img_link" onclick="abrir_popup('<?php echo base_url()."be/cursos_pdf/v_imagen_nombre/$id/".$row->idcursos_pdf;?>',1000,230);" src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
            </td>            
            <td align="center">
                
                <img style="margin:auto; display: block;" width="32" src="<?php echo base_url()."img/pdf.png"?>"/>
                <p><a style="color:#057fd6;text-decoration: underline;" href="<?php echo base_url().'pdf_cursos/'.$row->imagen;?>" target="_blank"><?php echo $row->imagen;?></a></p>
            </td>
            
            <td>
                <?php echo $row->orden; ?><br/>
                <img class="img_link" onclick="abrir_popup('<?php echo base_url()."be/cursos_pdf/v_imagen_orden/$id/".$row->idcursos_pdf;?>',1000,230);" src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
            </td>

<!--           <td>
                <?php  if($row->idprimera_foto=="1"){echo "Si";}else{ echo "No"; } ?><br/>
                <img class="img_link" onclick="abrir_popup('<?php echo base_url()."be/cursos_pdf/v_imagen_pf/$id/".$row->idcursos_pdf;?>',1000,230);" src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
            </td> -->
            ...
            <td style="text-align: center;" >
                        ...
                        <img class="img_link" onclick="abrir_popup('<?php echo base_url()."be/cursos_pdf/v_imagen_editar/$id/".$row->$idtabla;?>',1000,530);" src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;

                        <img class="img_link" onclick = "javascript:elimina_cursos_pdf('<?php echo $row->$idtabla; ?>')" src="<?php echo base_url();?>img/cancel.png" width="16" height="16" title="Eliminar"/>
