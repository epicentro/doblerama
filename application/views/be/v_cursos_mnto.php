   <div id="content_main" class="clearfix">
                ...
                <div id="dashboard_y">
				<h2 class="ico_mug"> Mnto. de Cursos</h2>
				<div class="clearfix">
...
<table  cellpadding="0" cellspacing="0" class="tb_mnto">
	...
	<tr>
            <td style="width: 30px;"><?php echo $row->idcursos; ?></td>
            ...
            <td style="text-align: center;" >
                 <p>
                     <?php //echo $this->be_funciones->cantidad_fotos($row->idcursos); ?>
                 </p>
                <a href="<?php echo base_url(); ?>be/cursos_programa/listar/<?php echo $row->$idtabla; ?>">
            ...
            <td style="text-align: center;" >
                <a href="<?php echo base_url(); ?>be/cursos_presentacion/listar/<?php echo $row->$idtabla; ?>">
                <img class="img_link"  src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
                </a>
            </td>
             ...
             <td style="text-align: center;" >
                 <p>
                     <?php echo $this->be_funciones->cantidad_fotos_cursos($row->idcursos); ?>
                 </p>
                <a href="<?php echo base_url(); ?>be/cursos_imagenes/listar/<?php echo $row->$idtabla; ?>">
                <img class="img_link"  src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
                </a>
            </td>
             ...
             <td style="text-align: center;" >
                 <p>
                     <?php echo $this->be_funciones->cantidad_word_cursos($row->idcursos); ?>
                 </p>
                <a href="<?php echo base_url(); ?>be/cursos_word/listar/<?php echo $row->$idtabla; ?>">
                <img class="img_link"  src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
                </a>
            </td>
             ...
             <td style="text-align: center;" >
                 <p>
                     <?php echo $this->be_funciones->cantidad_pdf_cursos($row->idcursos); ?>
                 </p>
                <a href="<?php echo base_url(); ?>be/cursos_pdf/listar/<?php echo $row->$idtabla; ?>">
                <img class="img_link"  src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
                </a>
            </td>                        
            <!--
            <td style="text-align: center;" >
                 <p>
                     <?php echo $this->be_funciones->cantidad_comentarios($row->idcursos); ?>
                 </p>
                <a href="<?php echo base_url(); ?>be/cursos_comentarios/listar/<?php echo $row->$idtabla; ?>">
                <img class="img_link"  src="<?php echo base_url();?>img/edit.png" width="16" height="16" title="Actualizar"/>
                </a>
            </td>
            -->
           <td style="text-align: center;"><?php echo $row->orden; ?></td>
            ...
            <th style="text-align: center;" >
                        ...
                        <img class="img_link" onclick = "javascript:elimina_cursos('<?php echo $row->$idtabla; ?>')" src="<?php echo base_url();?>img/cancel.png" width="16" height="16" title="Eliminar"/>
