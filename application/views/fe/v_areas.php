...
<?php $imagen=base_url()."img_areas/".$this->be_parametros->primera_foto_areas($idareas); ?>
                        <div class="panel-group margin20-top" id="accordion" role="tablist" aria-multiselectable="true">
                            <div class="panel panel-default">
                              ...
                              <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                <div class="panel-body">
                                            <div class="row">
                                              <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3"><img class="img-responsive" src="<?php echo $imagen;?>"></div>
                                              <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9"><?php echo $descripcion;?></div>                                              
                                            </div>                                
